document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      } else if (field.minLength && field.minLength > 0 && value.length < field.minLength && value !== '') {
        errorMessage = getFieldLabel(field) + ' must be at least ' + field.minLength + ' characters.';
  ...
  function createSuccessMessage(form) {
    ...
    el.textContent = 'Thank you! Your message has been sent successfully.';
  ...
  if (animatableElements.length > 0 && 'IntersectionObserver' in window) {
    ...
    const scrollObserver = new IntersectionObserver(function (entries, observer) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          ...
          const delay = el.getAttribute('data-delay') || el.dataset.delay || 0;
    ...
    animatableElements.forEach(function (el, index) {
      if (!el.hasAttribute('data-delay') && !el.dataset.delay) {
        const siblings = Array.from(el.parentElement ? el.parentElement.children : []);
        const siblingIndex = siblings.indexOf(el);
        if (siblingIndex > 0) {
          el.setAttribute('data-delay', (siblingIndex * 0.1).toFixed(1));
        }
      }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '30a96362-9835-4ece-919e-e075199d1051',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '30a96362-9835-4ece-919e-e075199d1051';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '30a96362-9835-4ece-919e-e075199d1051';
